  ...
  <main>
    ...
    <section class="container mx-auto">
      <div class="bg-white rounded border border-gray-200 relative flex flex-col">
        <!-- out comment the following code to use a globally registered directive while the following libe of code use a locally registered directive -->
...
export default {
  ...
  methods: {
    async getSongs() {
      // If arequest has been made, return this makes sure muktiple request are not been made at the same time.
    ...
    handleScroll() {
      ...
      // alternatively method for bottomOfWindows but it is less strict
