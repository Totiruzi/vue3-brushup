  ...
  <div class="bg-white rounded border border-gray-200 relative flex flex-col">
    ...
    <div class="p-6">
      ...
      <div
        ...
        :class="{ 'bg-green-400 border-green-400 border-solid': is_dragedover }"
        @drag.prevent.stop=""
        @dragstart.prevent.stop=""
        @dragend.prevent.stop="is_dragedover = false"
        @dragover.prevent.stop="is_dragedover = true"
        @dragenter.prevent.stop="is_dragedover = true"
        @dragleave.prevent.stop="is_dragedover = false"
